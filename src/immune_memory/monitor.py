...
class SystemMonitor:
    ...
    def check_health_and_react(self) -> dict[str, str] | None:
        ...
        self.log.append(
            "immune_system.threat_detected", actor="monitor", details={"symptoms": symptoms}
        )
        ...
        try:
            ...
            if current_gen:
                self.log.append(
                    "immune_system.rolling_back",
                    actor="monitor",
                    details={"generation": current_gen.generation_id},
                )
            ...
            self.log.append(
                "immune_system.rollback_failed", actor="monitor", details={"error": str(e)}
            )
