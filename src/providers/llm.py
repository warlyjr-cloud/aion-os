...
class AnthropicProvider:
    ...
    def propose(self, contract: IntentContract) -> list[CandidateProposal]:
        prompt = f"""
You are the AION OS Evolution Engine. Generate 2 NixOS candidate proposals to satisfy the objective: '{contract.objective}'.
...
Do not return any other text outside the JSON block. Valid action_types: package.propose, file.patch, service.configure.
"""
        try:
