...
- Inspect `AION_WHITEPAPER.md` line 24 and remove/replace any remaining "Oracle" or "central routing" references with decentralized enclave architecture terminology.
